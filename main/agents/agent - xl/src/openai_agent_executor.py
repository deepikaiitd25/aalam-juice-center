...
class OpenAIAgentExecutor(AgentExecutor):
            ...
            if message.tool_calls:
                for tool_call in message.tool_calls:
                    ...
                    if function_name in self.tools:
                        ...
                        # The A2A SDK expects a text string back for the UI
    ...
    def _extract_function_schema(self, func):
        ...
        for param_name, param in sig.parameters.items():
            ...
            # Explicitly define the object structure for lists/arrays
            if param.annotation == list or param.annotation == list[dict]:
                properties[param_name] = {
                    "type": "array",
                    "description": f"The list of {param_name} to be processed.",
                    "items": {
                        "type": "object",
                        "description": "A dictionary object representing a single item/row.",
                    }
                }
            ...
            # Make everything required by default to prevent LLM laziness
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue):
        ...
        # Extract the user prompt from the A2A Message object safely
        message_text = ""
